...
const Card = () => {
  return (
    <div className="w-[500px] h-[300px] flex justify-center items-center relative overflow-hidden">
      <div className="fixed bottom-[148px] z-10 left-32 circle-container">
          <div className="circle"></div>
        </div>
        <div className="fixed bottom-[44px] z-10 left-8 circles-con">
          <div className="circles"></div>
        </div>
      <div className="w-[450px] h-[300px] bg-[#ADA8C8] rounded-xl shadow-md relative  ">
        {/* Top Section */}
        <div className="w-full h-[160px] pt-6 pl-6">
          {/* Profile Image */}
          ...
          <div className="dots absolute w-64 h-40 top-5 right-10">
            <img
              className="absolute right-2 top-1 object-contain z-10"
              src={image}
              alt="Graph"
            />
          </div>
